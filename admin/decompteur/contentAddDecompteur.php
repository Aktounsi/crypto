        ...
        <div id="bgdiv" >
            <section id="sectionIndex" >
				...
				<div class="form-group">
                    ...
                    <div class="md-form mx-5 my-5">
                    <label  for="email">Selectionner le candidat qu'il représente ce décompteur :</label>
                    <select class="form-control" id="candidats" name="candidats" >
					<?php include('optionPartie.php');  ?>
					</select>                    
                    </div>
